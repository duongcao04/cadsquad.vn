    ...
    return (
        <div className="w-full h-[580px] lg:h-[750px] overflow-hidden">
            <div className="size-full relative">
                <img
                    src={BannerImg as unknown as string}
                    alt="banner"
                    className="size-full hidden lg:block pt-3"
                />
                <img
                    src={MobileBannerImg as unknown as string}
                    alt="banner"
            ...
            <div className="container relative">
                <div className="absolute bottom-10 text-background">
                    <h1 className="text-4xl lg:text-7xl font-bold lg:font-semibold tracking-normal flex flex-wrap">
                        {'Global Mechanical Design Partner'
                            .split(' ')
                            .map((char, idx) => {
                                return (
                                    <MotionSpan
                    ...
                    <p className="mt-2 ml-1 text-base lg:text-lg opacity-80 flex flex-wrap">
                        {'We turn innovative ideas, drawing into reality, delivering high-quality CAD and engineering solutions for a sustainable future.'
                            .split(' ')
                            .map((char, idx) => {
                                return (
                                    <MotionSpan
