            ...
            <AdminPageBody>
                ...
                >
                    <Tabs.List className="gap-6 w-full relative rounded-none p-0 border-b border-divider">
                        <Tabs.Tab id="services" className="max-w-fit px-0 h-12 font-medium data-[selected]:text-blue-600">
                            All Services
                        </Tabs.Tab>
                        <Tabs.Tab id="types" className="max-w-fit px-0 h-12 font-medium data-[selected]:text-blue-600">
                            Service Categories
                        </Tabs.Tab>
                    </Tabs.List>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 font-medium text-slate-900">
                                                    {enTranslation?.title || 'Untranslated'}
                                                </td>
                                                ...
                                                <td className="px-6 py-4 text-slate-500">
                                                    <span className="px-2.5 py-1 bg-slate-100 rounded-full text-xs font-medium">
                                                        {service.serviceType?.code || 'None'}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4 text-right">
                                                    <div className="flex justify-end gap-3">
                                                        <Link
                                                            to={INTERNAL_URLS.admin.management.services.editService(service.id)}
                                                        >
                            ...
                            <table className="w-full text-sm text-left">
                                <thead className="text-slate-500 bg-slate-50 border-b border-slate-200 font-medium">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4">Display Name (EN)</th>
                                    ...
                                    {serviceTypes.map((type) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 font-medium text-slate-900">
                                                    {enTranslation?.displayName || 'Untranslated'}
                                                </td>
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <div className="flex justify-end gap-3">
                                                        <Link
                                                            to={INTERNAL_URLS.admin.management.services.editServiceType(type.id)}
                                                        >
                                                            <Button isIconOnly variant="ghost">
                                                                <Edit size={16} />
                                                            </Button>
