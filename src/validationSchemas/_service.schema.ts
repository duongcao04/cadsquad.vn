...
export const ServiceSchema: ZodType<TService> = z.lazy(() => z.object({
	...
	verticalThumbnailId: z.string().nullish(),
	horizontalThumbnailId: z.string().nullish(),
...
export const CreateServiceFormSchema = z.object({
	...
	verticalThumbnailId: z.string().optional().transform(v => v === '' ? undefined : v),
	horizontalThumbnailId: z.string().optional().transform(v => v === '' ? undefined : v),
